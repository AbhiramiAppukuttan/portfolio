...
const categories = [
  {
    ...
    icon:  Code2,
    iconBg: 'bg-red-500/[0.08] border border-red-500/25 text-red-400',
    headingColor: 'text-white',
    tagBg: 'bg-white/[0.05] border-white/[0.08] text-zinc-300',
    keywords: [
  ...
  return (
    <section id="skills" className="py-24 lg:py-32 relative z-10">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <p className="font-mono text-red-500 text-sm tracking-widest mb-3">specialization</p>
          ...
          {categories.map((cat, i) => {
            ...
            return (
              <motion.div
                ...
                className="glass rounded-2xl p-6 hover:border-red-500/60 hover:-translate-y-1 transition-all duration-300"
              >
